...
- [x] **所有模組表單模板**: 課程、學生、員工、設施、班級表單模板已完成
...
3. **课程管理**: 完整的课程 CRUD 操作
4. **用户管理**: 员工和学生管理系统
5. **数据模型**: Course-Class 1:n 关系、描述字段
6. **表单系统**: Bootstrap 5 集成、一致的表单样式
7. **富文本编辑器**: Course 描述字段支持 CKEditor，为 WordPress 同步准备
